...
[CustomEditor(typeof(LPCAtlasManager))]
public class LPCAtlasManagerEditor : Editor
{
    ...
    private LPCAtlasManager am;
    private bool dirty;

    public override void OnInspectorGUI()
    {
        am = target as LPCAtlasManager;
        ...
        if (am.facialSprites == null) {
            dirty = true;
            am.facialSprites = new List<Sprite>();
        }
        ...
        if (am.weaponsSprites == null) {
            dirty = true;
            am.weaponsSprites = new List<Sprite>();
        }
    ...
    private void LoadFiles(string[] files) {
        foreach (string file in files) {
            ...
            } else if (collectionKey == "facial") {
                collection = am.facialSprites;
            ...
            } else if (collectionKey == "weapons") {
                collection = am.weaponsSprites;
